 ...
 */
public class AdminManageFetchData extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminManageFetchData() {
        super();
...
try{
			...
			System.out.println("gautambbbbbbbbbbbbbbbbbbb");
			...
			view.forward(request, response);*/
				...
				AdminBankFdDetailsBO.myMethod(bankId,bankName,interest,months,updatedBy,updatedOn);
				
				AdminManage.idS="gautam";
				AdminManage.pass="gautam89";
				new AdminManage().doPost(request, response);
